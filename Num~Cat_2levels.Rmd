...
ggplot(df) + aes(x="Cult", y="VitC") + geom_boxplot()
```
...
```{python}
df.groupby("Cult")['VitC'].describe().reset_index()	
```
...
c39 = df['VitC'][(df["Cult"] == 'c39')]

c52 = df['VitC'][(df["Cult"] == 'c52')]
 
t, p =stats.ttest_ind(c39, c52, equal_var=False)
